// <copyright file="AppPopup.cs" company="Drastic Actions">
// Copyright (c) Drastic Actions. All rights reserved.
// </copyright>

using System;
using Forms9Patch;
using IPopup = YoutubeSubtitleExplorer.Interfaces.IPopup;

namespace YoutubeSubtitleExplorer.Controls
{
    /// <summary>
    /// App Popup.
    /// </summary>
    public class AppPopup : IPopup, IDisposable
    {
